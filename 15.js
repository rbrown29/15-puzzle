$(
    ...
    [13, 14, 15, null]
        ...
        function resize() {
            ...
            var windowWidth = $(window).width() - 2 * parseInt($("body").css("margin") || 0);
            var windowHeight = $(window).height() - 2 * parseInt($("body").css("margin"));
            ...
            for (var y = 0; y < 4; y++) {
                for (var x = 0; x < 4; x++) {
                    ...
                    if (value < 16) {
                        ...
                        tiles[y][x] = tile;
                        if (x % 2) {
                            tile.css("backgroundColor", "midnightblue");
                        } else {
